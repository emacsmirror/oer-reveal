...
"))
  ...
  (let ((oer-reveal-with-alternate-types '("org" "pdf"))
    ...
    (should (equal (oer-reveal-add-alternate-types
                   ...
                   "#+HTML_HEAD: <link rel=\"alternate\" type=\"text/org\" href=\"git/blob/main/presentation.org\"/>
"))
    (should (equal (oer-reveal-add-alternate-types
  ...
  (let ((meta (make-temp-file "oer.meta"))
    ...
    (let ((result
      ...
      (should (equal (car result)
                     "<div about=\"./figures/doesnotexist.png\" typeof=\"dcmitype:StillImage\" class=\"figure\"><p><img data-src=\"./figures/doesnotexist.png\" alt=\"Figure\" /></p><p></p><p style=\"\">&ldquo;<span property=\"dcterms:title\">Figure</span>&rdquo; by <a rel=\"cc:attributionURL dcterms:creator\" href=\"https://gitlab.com/lechten\" property=\"cc:attributionName\">Jens Lechtenbörger</a> under <a rel=\"license\" href=\"https://creativecommons.org/publicdomain/zero/1.0/\">CC0 1.0</a>; from <a rel=\"dcterms:source\" href=\"https://example.org/\">Sample source</a></p></div>"))
      (should (equal (car result-external)
                     "<div about=\"https://drawings.jvns.ca/drawings/process.svg\" typeof=\"dcmitype:StillImage\" class=\"figure\"><p><img data-src=\"https://drawings.jvns.ca/drawings/process.svg\" alt=\"What's in a process?\" /></p><p></p><p style=\"\">&ldquo;<span property=\"dcterms:title\">What's in a process?</span>&rdquo; © 2016 Julia Evans, all rights reserved; from <a rel=\"dcterms:source\" href=\"https://drawings.jvns.ca/process/\">julia's drawings</a>. Displayed here with personal permission.</p></div>"))
      (should (equal (car result-gif)
                     "<div about=\"./figures/doesnotexist.gif\" typeof=\"dcmitype:Image\" class=\"figure\"><p><img data-src=\"./figures/doesnotexist.gif\" alt=\"Figure\" /></p><p></p><p style=\"\">&ldquo;<span property=\"dcterms:title\">Figure</span>&rdquo; by <span property=\"cc:attributionName\">Jens Lechtenbörger</span> under <a rel=\"license\" href=\"https://creativecommons.org/publicdomain/zero/1.0/\">CC0 1.0</a>; from <a rel=\"dcterms:source\" href=\"https://example.org/\">Sample source</a></p></div>"))
      (should (equal (car result-short)
                     "<div about=\"./figures/doesnotexist.png\" typeof=\"dcmitype:StillImage\" class=\"figure\"><p><img data-src=\"./figures/doesnotexist.png\" alt=\"Figure\" /></p><p></p><p style=\"\"><a rel=\"dcterms:source\" href=\"https://example.org/\">Figure</a> under <a rel=\"license\" href=\"https://creativecommons.org/publicdomain/zero/1.0/\">CC0 1.0</a></p></div>"))
  ...
  (let ((meta (make-temp-file "oer.meta"))
    ...
    (let ((result
          ...
          (result-full
           (oer-reveal--attribution-strings meta "A caption" "50vh" "figure fragment appear" nil nil "data-fragment-index=\"1\"")))
      (should (equal (car result)
                     "<div about=\"./figures/doesnotexist.png\" typeof=\"schema:ImageObject schema:LearningResource dcmitype:StillImage\" class=\"figure\"><p><img data-src=\"./figures/doesnotexist.png\" alt=\"Figure\" /></p><p property=\"schema:caption\">A caption</p><p style=\"\">&ldquo;<span property=\"dcterms:title\">Figure</span>&rdquo; by <a rel=\"cc:attributionURL dcterms:creator\" href=\"https://gitlab.com/lechten\" property=\"cc:attributionName\">Jens Lechtenbörger</a> under <a rel=\"license\" href=\"https://creativecommons.org/publicdomain/zero/1.0/\">CC0 1.0</a>; from <a rel=\"dcterms:source\" href=\"https://example.org/\">Sample source</a></p></div>"))
      (should (equal (car result-short)
                     "<div about=\"./figures/doesnotexist.png\" typeof=\"schema:ImageObject schema:LearningResource dcmitype:StillImage\" class=\"figure\"><p><img data-src=\"./figures/doesnotexist.png\" alt=\"Figure\" /></p><p></p><p style=\"\"><a rel=\"dcterms:source\" href=\"https://example.org/\">Figure</a> under <a rel=\"license\" href=\"https://creativecommons.org/publicdomain/zero/1.0/\">CC0 1.0</a></p></div>"))
      (should (equal (car result-full)
