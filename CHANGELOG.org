...
# SPDX-FileCopyrightText: 2019-2026 Jens Lechtenbörger
...
** [4.35.1] - 2026-01-16
*** Fixed
    - Use escape sequence %I (introduced in org-re-reveal 3.38.0) on
      title slide [[file:title-slide/course-uni-ms.html]]
      to separate author and instructor

** [4.35.0] - 2026-01-12
*** Added
    - Title slide for university courses (outside MLDE)
      [[file:title-slide/course-uni-ms.html]]

** [4.34.0] - 2025-08-26
*** Added
    - \vspace{0pt} for minipages of two-column mode with [t]

** [4.33.0] - 2025-08-26
*** Added
    - Improve layout of condensed PDF in [[file:org/config.org]]
    - Add smaller CSS settings in [[file:css/oer-reveal.css]]

** [4.32.0] - 2025-06-22
*** Added
    - For LaTeX export, use package animate to replace animated GIF
      with single images

** [4.31.2] - 2025-06-22
*** Fixed
    - Wrap LaTeX code for image grid in export block

** [4.31.1] - 2025-06-21
*** Fixed
    - Using sizes for images grids of version 4.31.0 led to one long
      line of subfigures in LaTeX export.  Break into multiple lines.
