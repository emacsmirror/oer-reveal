...
#+MACRO: blackcode (eval (message "@@html:<code><span style=\"color:black; font-size:smaller;\">%s</span></code>@@ @@latex:\verb|%s|@@" (org-html-encode-plain-text $1) $1))
#+MACRO: redcode (eval (message "@@html:<code><span style=\"color:darkred; font-size:smaller;\">%s</span></code>@@ @@latex:\rverb|%s|@@" (org-html-encode-plain-text $1) $1))
#+MACRO: greencode (eval (message "@@html:<code><span style=\"color:darkgreen; font-size:smaller;\">%s</span></code>@@ @@latex:\gverb|%s|@@" (org-html-encode-plain-text $1) $1))
#+MACRO: bluecode (eval (message "@@html:<code><span style=\"color:darkblue; font-size:smaller;\">%s</span></code>@@ @@latex:\bverb|%s|@@" (org-html-encode-plain-text $1) $1))
