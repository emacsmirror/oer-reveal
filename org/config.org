...
# and an attribute specifying whether a long (default/nil), short (t),
# or no license (none) should be used (arguments are documented for
# function oer-reveal--export-attribution-helper).
